...
@NgModule({
  ...
  declarations: [MadeWithLoveComponent, HeartComponent],
  entryComponents: [MadeWithLoveComponent, HeartComponent]
})
export class AppModule {
  constructor(private injector: Injector) {
    const madeWithLoveElement = createCustomElement(MadeWithLoveComponent, {
      injector
    });
